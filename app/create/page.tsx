...
export default function CreatePersonaPage() {
  ...
  return <main>
    ...
    <section className="formHero"><p className="eyebrow">CREATE PERSONA</p><h1>Costruiamo un'identità, non solo un'immagine.</h1><p>Definisci i tratti canonici. Saranno la base dell'Identity Lock e del Reference Pack.</p></section>

...
export default function MasterStudio({personaId,initialReferences}:{personaId:string;initialReferences:Ref[]}){
 ...
 return <section>
  ...
  <div className="emptyState" style={{marginBottom:24,textAlign:"left"}}>
   ...
   <p>La foto sorgente non diventerà il Master: verrà usata solo per creare un'identità sintetica materialmente diversa, mantenendo il livello di realismo fotografico.</p>
